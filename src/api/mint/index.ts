  ...
  introduction: [
    {
      title: 'NFT Sale',
      content:
        'Ultimate Edition(15) - English auction & Open-bid 2nd price<br>Gold Edition(450) - Fixed price at 0.6 ETH'
    },
    {
      title: 'NFT Utilities',
      content:
